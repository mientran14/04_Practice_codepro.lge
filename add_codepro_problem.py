...
if __name__ == "__main__":
    ...
    # https://codepro.lge.com/exam/19/overseas-questions-for-previous-test/quiz/3%3Fembed
    problem_link = sys.argv[1]
    problem_name = problem_link.split("/")[7]
    commit_message = f"codepro problem: {problem_name.title()}"
